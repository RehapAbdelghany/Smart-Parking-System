...
class InteractiveGateSystem:
    ...
    def run(self):
        ...
        # 1. إنشاء النافذة مع خاصية WINDOW_NORMAL للسماح بتغيير الحجم
        cv2.namedWindow(self.window_name, cv2.WINDOW_NORMAL)
        
        # 2. (اختياري) تحديد حجم افتراضي للنافذة عند الفتح
        ...
        while cap.isOpened():
            ...
            # عرض الفريم مباشرة (النافذة ستتكفل بتغيير الحجم إذا سحبت أطرافها)
...
if __name__ == "__main__":
    ...
    system = InteractiveGateSystem(camera_id=1) 
    system.run()